...
## Rule-Based Betting (単勝)
- 本命単勝の買い目ルール: オッズ3倍未満は予測勝率40%以上のみ購入、5〜20倍は購入、それ以外は見送り（src/betting_rules.py）
- Bets: 1257, hit 14.96%, ROI 82.8%, profit -21660 yen
- Skipped by reason: SKIP_HIGH_ODDS=1247, SKIP_LOW_ODDS_LOW_PROB=268, SKIP_MID_LOW_ODDS=462
...
- 理由分類（AI rank 1 かつ popularity >= 2）:
  - TIE_BREAK_UMABAN: 520件
  - NO_HISTORY: 864件
  - HIGHER_HISTORY_WIN_RATE: 1266件
